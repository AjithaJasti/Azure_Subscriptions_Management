    ...
    const saveFormData =  (element, obj) => {
        ...
        const dataoptions={
          method: "PUT",
            ...
            body: JSON.stringify({
                "properties": {
                    "roleDefinitionId":  element + "/providers/Microsoft.Authorization/roleDefinitions/"+ values.roleName,
                    "principalId": obj
                  }
        })
      };
         fetch('https://management.azure.com/' + element +'/providers/Microsoft.Authorization/roleAssignments/'+ uuid() +'?api-version=2015-07-01',dataoptions)
        .then((data) => {
          console.log(data);
        })
        .catch((err) => {
